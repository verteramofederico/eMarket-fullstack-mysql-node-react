...
const productsController = {
    ...
    ProductCreate: (req, res) => res.render("products/productCreate", {product:productModel.all()}),
    ProductEdit: (req, res) => res.render("products/productEdit", {product:productModel.one(req.params.id)}),
